...
\usepackage{amsmath,graphicx,amsthm}
\usepackage{lineno,hyperref}
\usepackage{epsfig}
\usepackage{amssymb, amsfonts,mathrsfs,euscript, bm}
...
%\copyrightnotice{978-1-5386-5477-4/18/\$31.00 {\copyright}2018 IEEE}

%\toappear{2018 IEEE International Workshop on Machine Learning for Signal Processing, Sept.\ 17--20, 2018, Aalborg, Denmark}



\newtheoremstyle{remarkupright}%
...
\theoremstyle{remarkupright}
\newtheorem{remark}{Remark}


% Title.
% ------
\title{A Unified Analysis of Generalization and Sample Complexity for Semi-Supervised Domain Adaptation}
%
% Single address.
% ---------------
%\name{Author(s) Name(s) omitted for double blind review \thanks{Thanks to XYZ agency for funding.}}
\author{Elif Vural\thanks{Department of Electrical and Electronics Engineering, METU, Ankara}, H\"useyin Karaca\thanks{Department of Electrical and Electronics Engineering, Bilkent University, Ankara}}
%
% For example:
% ------------
%\address{School\\
